    ...
    <BeekeeperLayout>
      <div className="max-w-3xl mx-auto space-y-6">
        ...
        {loading && !batch ? (
          ...
          <Card className="text-center py-16 bg-white border border-slate-200 shadow-sm">
          ...
          <>
            ...
            <Card className="p-6 bg-white border border-slate-200 shadow-sm">
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="text-blue-600 font-mono font-black text-xl tracking-wide">
                      {batch.batchId}
                    </p>
                  ...
                  >
                    ...
                    <div
                      className={`text-slate-900 font-semibold ${mono ? 'font-mono text-sm' : ''
                        } ${highlight ? 'text-amber-700 text-lg font-mono font-bold' : ''}`}
                    >
                      {value}
                    </div>
                  </div>
            ...
            {/* Reserved Sections for Future Phases */}
