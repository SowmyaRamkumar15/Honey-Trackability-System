...
export const BeekeeperOnboardingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col justify-between px-4 py-8 relative">
      {/* Background glow */}
      <div className="fixed top-[-10%] left-[-10%] w-[500px] h-[500px] rounded-full bg-blue-500/5 blur-3xl pointer-events-none" />
      ...
      {/* Footer info */}
      <footer className="max-w-xl mx-auto w-full text-center text-xs text-slate-500 mt-6 font-medium">
